...
def normalize_chat_messages(
    ...
    *,
    ...
    # Strip ALL tool_calls and tool messages from the conversation.
    # Freebuff/codebuff handles tool calls internally; forwarding them
    # from client history causes upstream 400 "insufficient tool messages".
    normalized = [
